...
namespace MWS_Orders\Model\ListOrderItemsResponse;
 ...
 */
 ...
 class MWS_ListOrderItemsResponse extends Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'ListOrderItemsResult' => array('FieldValue' => null, 'FieldType' => 'MWS_ListOrderItemsResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_ListOrderItemsResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct MWS_ListOrderItemsResponse from provided XML. 
