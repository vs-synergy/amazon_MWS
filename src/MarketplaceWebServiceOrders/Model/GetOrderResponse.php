...
namespace MWS_Orders\Model\GetOrderResponse;
 ...
 */
 ...
 class MWS_GetOrderResponse extends Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetOrderResult' => array('FieldValue' => null, 'FieldType' => 'MWS_GetOrderResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_GetOrderResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct MWS_GetOrderResponse from provided XML. 
