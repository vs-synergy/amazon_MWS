...
namespace MWS_Products\Model\GetMyFeesEstimateResponse;
 ...
 */
 ...
 class MWS_GetMyFeesEstimateResponse extends Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetMyFeesEstimateResult' => array('FieldValue' => null, 'FieldType' => 'MWS_GetMyFeesEstimateResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_GetMyFeesEstimateResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct MWS_GetMyFeesEstimateResponse from provided XML. 
