...
namespace MWS_Products\Model\GetLowestOfferListingsForASINResponse;
 ...
 */
 ...
 class MWS_GetLowestOfferListingsForASINResponse extends Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetLowestOfferListingsForASINResult' => array('FieldValue' => array(), 'FieldType' => array('MWS_GetLowestOfferListingsForASINResult')),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_GetLowestOfferListingsForASINResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct MWS_GetLowestOfferListingsForASINResponse from provided XML. 
