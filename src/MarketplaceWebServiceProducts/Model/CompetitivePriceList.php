...
namespace MWS_Products\Model\CompetitivePriceList;
 ...
 */
 ...
 class MWS_CompetitivePriceList extends Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'CompetitivePrice' => array('FieldValue' => array(), 'FieldType' => array('MWS_CompetitivePriceType')),
    );
