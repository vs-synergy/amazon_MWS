...
namespace MWS_Products\Model\GetMyPriceForASINResponse;
 ...
 */
 ...
 class MWS_GetMyPriceForASINResponse extends Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetMyPriceForASINResult' => array('FieldValue' => array(), 'FieldType' => array('MWS_GetMyPriceForASINResult')),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_GetMyPriceForASINResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct MWS_GetMyPriceForASINResponse from provided XML. 
