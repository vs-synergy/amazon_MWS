...
namespace MWS_Products\Model\NumberOfOfferListingsList;
 ...
 */
 ...
 class MWS_NumberOfOfferListingsList extends Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'OfferListingCount' => array('FieldValue' => array(), 'FieldType' => array('MWS_OfferListingCountType')),
    );
