...
namespace MWS_Products\Model\GetLowestPricedOffersForASINResponse;
 ...
 */
 ...
 class MWS_GetLowestPricedOffersForASINResponse extends Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetLowestPricedOffersForASINResult' => array('FieldValue' => null, 'FieldType' => 'MWS_GetLowestPricedOffersForASINResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_GetLowestPricedOffersForASINResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct MWS_GetLowestPricedOffersForASINResponse from provided XML. 
