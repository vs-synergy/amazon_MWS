...
namespace MWS_Products\Model\GetMatchingProductForIdResponse;
 ...
 */
 ...
 class MWS_GetMatchingProductForIdResponse extends Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetMatchingProductForIdResult' => array('FieldValue' => array(), 'FieldType' => array('MWS_GetMatchingProductForIdResult')),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_GetMatchingProductForIdResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct MWS_GetMatchingProductForIdResponse from provided XML. 
