 ...
 */
namespace MWS\Model\GetReportListResponse;
use MWS\Model;
 ...
 * </ul>
 */ 
class MWS_GetReportListResponse extends Model
{
    ...
    {
        $this->fields = array (
        'GetReportListResult' => array('FieldValue' => null, 'FieldType' => 'MWS_GetReportListResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_GetReportListResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct MWS_GetReportListResponse from provided XML. 
