 ...
 */
namespace MWS\Model\GetReportScheduleListResponse;
use MWS\Model;
 ...
 * </ul>
 */ 
class MWS_GetReportScheduleListResponse extends Model
{
    ...
    {
        $this->fields = array (
        'GetReportScheduleListResult' => array('FieldValue' => null, 'FieldType' => 'MWS_GetReportScheduleListResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_GetReportScheduleListResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct MWS_GetReportScheduleListResponse from provided XML. 
