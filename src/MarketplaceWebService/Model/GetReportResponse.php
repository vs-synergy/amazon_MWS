 ...
 */
namespace MWS\Model\GetReportResponse;
use MWS\Model;
 ...
 * </ul>
 */ 
class MWS_GetReportResponse extends Model
{
    ...
    {
        $this->fields = array (
        'GetReportResult' => array('FieldValue' => null, 'FieldType' => 'MWS_GetReportResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_GetReportResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct MWS_GetReportResponse from provided XML. 
