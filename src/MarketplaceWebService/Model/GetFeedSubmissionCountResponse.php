 ...
 */
namespace MWS\Model\GetFeedSubmissionCountResponse;
use MWS\Model;
 ...
 * </ul>
 */ 
class MWS_GetFeedSubmissionCountResponse extends Model
{
    ...
    {
        $this->fields = array (
        'GetFeedSubmissionCountResult' => array('FieldValue' => null, 'FieldType' => 'MWS_GetFeedSubmissionCountResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_GetFeedSubmissionCountResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct MWS_GetFeedSubmissionCountResponse from provided XML. 
