 ...
 */
namespace MWS\Model\RequestReportResponse;
use MWS\Model;
 ...
 * </ul>
 */ 
class MWS_RequestReportResponse extends Model
{
    ...
    {
        $this->fields = array (
        'RequestReportResult' => array('FieldValue' => null, 'FieldType' => 'MWS_RequestReportResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_RequestReportResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct MWS_RequestReportResponse from provided XML. 
