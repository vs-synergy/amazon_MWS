 ...
 */
namespace MWS\Model\UpdateReportAcknowledgementsResponse;
use MWS\Model;
 ...
 * </ul>
 */ 
class MWS_UpdateReportAcknowledgementsResponse extends Model
{
    ...
    {
        $this->fields = array (
        'UpdateReportAcknowledgementsResult' => array('FieldValue' => null, 'FieldType' => 'MWS_UpdateReportAcknowledgementsResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_UpdateReportAcknowledgementsResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct MWS_UpdateReportAcknowledgementsResponse from provided XML. 
