 ...
 */
namespace MWS\Model\GetFeedSubmissionListByNextTokenResponse;
use MWS\Model;
 ...
 * </ul>
 */ 
class MWS_GetFeedSubmissionListByNextTokenResponse extends Model
{
    ...
    {
        $this->fields = array (
        'GetFeedSubmissionListByNextTokenResult' => array('FieldValue' => null, 'FieldType' => 'MWS_GetFeedSubmissionListByNextTokenResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_GetFeedSubmissionListByNextTokenResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct MWS_GetFeedSubmissionListByNextTokenResponse from provided XML. 
