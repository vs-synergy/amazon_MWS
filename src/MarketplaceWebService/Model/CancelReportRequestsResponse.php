 ...
 */
namespace MWS\Model\CancelReportRequestsResponse;
use MWS\Model;
 ...
 * </ul>
 */ 
class MWS_CancelReportRequestsResponse extends Model
{
    ...
    {
        $this->fields = array (
        'CancelReportRequestsResult' => array('FieldValue' => null, 'FieldType' => 'MWS_CancelReportRequestsResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_CancelReportRequestsResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct MWS_CancelReportRequestsResponse from provided XML. 
