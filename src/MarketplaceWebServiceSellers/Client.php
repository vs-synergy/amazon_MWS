...
use MWS_Sellers\Model\GetServiceStatusRequest\MWS_GetServiceStatusRequest;
use MWS_Sellers\Model\GetServiceStatusResponse\MWS_GetServiceStatusResponse;

use MWS_Sellers\Model\ListMarketplaceParticipationsRequest\MWS_ListMarketplaceParticipationsRequest;
use MWS_Sellers\Model\ListMarketplaceParticipationsResponse\MWS_ListMarketplaceParticipationsResponse;

use MWS_Sellers\Model\ListMarketplaceParticipationsByNextTokenRequest\MWS_ListMarketplaceParticipationsByNextTokenRequest;
use MWS_Sellers\Model\ListMarketplaceParticipationsByNextTokenResponse\MWS_ListMarketplaceParticipationsByNextTokenResponse;
...
class MWS_Client implements MWS_Interface
{
    ...
    {
        if (!($request instanceof MWS_ListMarketplaceParticipationsRequest)) {
            require_once (dirname(__FILE__) . '/Model/ListMarketplaceParticipationsRequest.php');
            $request = new MWS_ListMarketplaceParticipationsRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        ...
        $response = MWS_ListMarketplaceParticipationsResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
    ...
    {
        if (!($request instanceof MWS_ListMarketplaceParticipationsByNextTokenRequest)) {
            require_once (dirname(__FILE__) . '/Model/ListMarketplaceParticipationsByNextTokenRequest.php');
            $request = new MWS_ListMarketplaceParticipationsByNextTokenRequest($request);
        }
        $parameters = $request->toQueryParameterArray();
        ...
        $response = MWS_ListMarketplaceParticipationsByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
        $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
        return $response;
    }
