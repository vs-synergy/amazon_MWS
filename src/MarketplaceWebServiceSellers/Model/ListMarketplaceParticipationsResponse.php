...
namespace MWS_Sellers\Model\ListMarketplaceParticipationsResponse;
use MWS_Sellers\Model;
 ...
 */
 ...
 class MWS_ListMarketplaceParticipationsResponse extends Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'ListMarketplaceParticipationsResult' => array('FieldValue' => null, 'FieldType' => 'MWS_ListMarketplaceParticipationsResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWS_ListMarketplaceParticipationsResponse(($response->item(0)));
        } else {
            throw new \Exception ("Unable to construct MWS_ListMarketplaceParticipationsResponse from provided XML. 
