...
namespace MWS_Sellers\Model\ListMarketplaceParticipationsByNextTokenResponse;
 ...
 */
 ...
 class MWS_ListMarketplaceParticipationsByNextTokenResponse extends Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'ListMarketplaceParticipationsByNextTokenResult' => array('FieldValue' => null, 'FieldType' => 'MWS_ListMarketplaceParticipationsByNextTokenResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            ...
            throw new \Exception ("Unable to construct MWS_ListMarketplaceParticipationsByNextTokenResponse from provided XML. 
