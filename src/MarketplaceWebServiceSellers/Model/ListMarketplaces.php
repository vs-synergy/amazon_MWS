...
namespace MWS_Sellers\Model\ListMarketplaces;
 ...
 */
 ...
 class MWS_ListMarketplaces extends Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'Marketplace' => array('FieldValue' => array(), 'FieldType' => array('MWS_Marketplace')),
    );
